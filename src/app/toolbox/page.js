                        ...
                        {tools.map((tool) => (
                            tool.isLink ? (
                                ...
                                <button
                                    ...
                                    className={`
                            group flex lg:flex-col items-center lg:items-start gap-4 p-5 rounded-3xl border transition-all text-left min-w-[220px] lg:min-w-0 relative overflow-hidden cursor-pointer
                            ${activeTab === tool.id
