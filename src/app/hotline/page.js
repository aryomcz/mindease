...
export default function HotlinePage() {
  ...
  return (
    // Container Utama (Background Transparan/Adaptif)
    <div className="w-full relative overflow-hidden min-h-screen text-gray-800">
      ...
      <div className="max-w-5xl mx-auto px-6 pt-36 pb-32 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in-down">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/60 backdrop-blur border border-white/50 text-rose-600 text-sm font-bold mb-4 shadow-sm animate-pulse glass-card">
          ...
          <p className="text-lg text-gray-600 mt-4 max-w-2xl mx-auto font-medium">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex gap-3">
                        <a 
                            ...
                            // PERBAIKAN 1: Gunakan 'text-black' agar tetap hitam di mode apapun
                            className="flex-1 py-3 bg-white text-black rounded-xl font-bold text-center shadow-lg hover:bg-gray-100 transition flex items-center justify-center gap-2"
                        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 gap-4">
              {professionalServices.map((srv, idx) => (
                <div key={idx} className="glass-card p-6 rounded-3xl hover-3d flex items-center gap-5 group border border-white/40 shadow-sm hover:shadow-md">
          ...
          <div className="relative">
             {/* PERBAIKAN 2: Hapus 'glass-panel', Pakai 'bg-teal-700' solid agar tulisan putih terbaca */}
             <div className="bg-teal-700 text-white p-8 rounded-[2.5rem] shadow-2xl sticky top-32 overflow-hidden z-10">
